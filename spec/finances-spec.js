...
(function() {
  ...
  describe("finances", function() {
    ...
    it('should know how much each person (account) owes (w/o non-trivial cycles)', function() {
      a1.paysAndUses(i1);
      a2.pays(i2);
      a3.paysAndUses(i3);
      a1.uses(i2);
    ...
    return xit('should know how much each person (account) owes (w/ non-trivial cycles)', function() {
      a1.uses(i1);
      a2.pays(i1);
      a2.uses(i2);
      a3.pays(i2);
